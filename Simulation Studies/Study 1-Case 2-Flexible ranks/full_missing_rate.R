...
save(full_miss0, file="./full_new/full_miss0.Rda")
...
save(full_miss10, file="./full_new/full_miss10.Rda")
...
save(full_miss20, file="./full_new/full_miss20.Rda")
...
save(full_miss50, file="./full_new/full_miss50.Rda")
