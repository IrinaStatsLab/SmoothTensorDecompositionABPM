...
results_noise01_full <- foreach(i = 1:N, .packages = c("rTensor","MASS","refund","SmoothHOOI")) %dorng%{
...
# save(results_noise01_full, file="/home/lyqian/ABPM_new/sim_res_noise01_full.Rda")

## noise level 2*empirical var
set.seed(13579)

results_noise2_full <- foreach(i = 1:N, .packages = c("rTensor","MASS","refund","SmoothHOOI")) %dorng%{
...
# save(results_noise2_full, file="/home/lyqian/ABPM_new/sim_res_noise2_full.Rda")
