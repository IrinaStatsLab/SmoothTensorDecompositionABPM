...
fixr_missstruc <- foreach(i = 1:N, .packages = c("rTensor","MASS","refund","multiway","funData","MFPCA","SmoothHOOI")) %dorng%{
...
save(fixr_missstruc, file="./fixr_new/fixr_missstruc.Rda")
