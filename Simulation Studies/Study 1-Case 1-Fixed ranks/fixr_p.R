...
save(fixr_p50, file="./fixr_new/fixr_p50.Rda")

## p = 500
set.seed(65432)

fixr_p500 <- foreach(i = 1:N, .packages = c("rTensor","MASS","refund","multiway","funData","MFPCA","SmoothHOOI")) %dorng%{
  sim_data <- sim_data2(L = L_tilde, R= R_tilde, mean_G = mean_G, cov_G = cov_G, 
...
save(fixr_p500, file="./fixr_new/fixr_p500.Rda")
