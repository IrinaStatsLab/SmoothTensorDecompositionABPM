...
miss0 <- foreach(i = 1:N, .packages = c("rTensor","MASS","refund","multiway","funData","MFPCA","SmoothHOOI")) %dorng%{
  ...
  kcv_true_opt <- kcv(tnsr=Mmiss@data, rank_grid=true_rank_grid, lambda_seq=lambda_seq, k=10,
  ...
  # kcv_42_opt <- kcv(tnsr=Mmiss@data, rank_grid=rank_grid_42, lambda_seq=lambda_seq, k=10,
  #                  L0 = NULL, D = D2, tol = 0.1, max_iter = 500, init = 0)
  
  kcv_42_res <- mglram(Mmiss@data, ranks=rank_grid_42, lambda=as.numeric(kcv_true_opt$opt_para[3]),
                       L0=NULL, D = D2, tol = 0.1, max_iter = 500, init = 0)
  ...
  # kcv_62_opt <- kcv(tnsr=Mmiss@data, rank_grid=rank_grid_62, lambda_seq=lambda_seq, k=10,
  #                  L0 = NULL, D = D2, tol = 0.1, max_iter = 500, init = 0)
  
  kcv_62_res <- mglram(Mmiss@data, ranks=rank_grid_62, lambda=as.numeric(kcv_true_opt$opt_para[3]),
                       L0=NULL, D = D2, tol = 0.1, max_iter = 500, init = 0)
  ...
  # kcv_33_opt <- kcv(tnsr=Mmiss@data, rank_grid=rank_grid_33, lambda_seq=lambda_seq, k=10,
  #                  L0 = NULL, D = D2, tol = 0.1, max_iter = 500, init = 0)
  
  kcv_33_res <- mglram(Mmiss@data, ranks=rank_grid_33, lambda=as.numeric(kcv_true_opt$opt_para[3]),
                       L0=NULL, D = D2, tol = 0.1, max_iter = 500, init = 0)
  ...
  # kcv_43_opt <- kcv(tnsr=Mmiss@data, rank_grid=rank_grid_43, lambda_seq=lambda_seq, k=10,
  #                  L0 = NULL, D = D2, tol = 0.1, max_iter = 500, init = 0)
  
  kcv_43_res <- mglram(Mmiss@data, ranks=rank_grid_43, lambda=as.numeric(kcv_true_opt$opt_para[3]),
                       L0=NULL, D = D2, tol = 0.1, max_iter = 500, init = 0)
  ...
  # kcv_63_opt <- kcv(tnsr=Mmiss@data, rank_grid=rank_grid_63, lambda_seq=lambda_seq, k=10,
  #                  L0 = NULL, D = D2, tol = 0.1, max_iter = 500, init = 0)
  
  kcv_63_res <- mglram(Mmiss@data, ranks=rank_grid_63, lambda=as.numeric(kcv_true_opt$opt_para[3]),
                       L0=NULL, D = D2, tol = 0.1, max_iter = 500, init = 0)
  ...
  output <- list("kcv_true_loss"=kcv_true_loss, lambda_true = as.numeric(kcv_true_opt$opt_para[3]),
                 "kcv_42_lossM"=kcv_42_lossM, "kcv_42_loss_truncated"=kcv_42_loss_truncated,
                 "kcv_62_lossM"=kcv_62_lossM, "kcv_62_loss_truncated"=kcv_62_loss_truncated,
                 "kcv_33_lossM"=kcv_33_lossM, "kcv_33_loss_truncated"=kcv_33_loss_truncated,
                 "kcv_43_lossM"=kcv_43_lossM, "kcv_43_loss_truncated"=kcv_43_loss_truncated,
                 "kcv_63_lossM"=kcv_63_lossM, "kcv_63_loss_truncated"=kcv_63_loss_truncated
  )
  output
}

save(miss0, file="./rank_misspecification_samelambda/miss0.Rda")
...
save(miss10, file="./rank_misspecification_samelambda/miss10.Rda")
...
save(miss20, file="./rank_misspecification_samelambda/miss20.Rda")
...
save(miss50, file="./rank_misspecification_samelambda/miss50.Rda")
...
save(missstruc, file="./rank_misspecification_samelambda/missstruc.Rda")
...
save(p50, file="./rank_misspecification_samelambda/p50.Rda")
...
save(p500, file="./rank_misspecification_samelambda/p500.Rda")
...
save(noise0, file="./rank_misspecification_samelambda/noise0.Rda")
...
save(noise05, file="./rank_misspecification_samelambda/noise05.Rda")
...
save(noise15, file="./rank_misspecification_samelambda/noise15.Rda")
...
save(noise2, file="./rank_misspecification_samelambda/noise2.Rda")
